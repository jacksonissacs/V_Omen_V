...
npm run operator -- review approve <id> --by "Operator Name" [--note "…"] [--stance contextual] [--reliability 0.40]
...
npm run operator -- intake import --queue .omen/intake/queue.json --item <id> --by "Operator Name"
